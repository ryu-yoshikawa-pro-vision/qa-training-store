...
各工数には幅があります。これは、初学者がコード、CLI、Git、CIなどで行う試行錯誤や復習量に個人差があるためです。各内訳の幅と標準工数の幅は独立した想定であり、内訳の最小値・最大値を単純合算した値とは一致しない場合があります。
...
| 範囲 | 標準工数の想定 | 全体の想定範囲 |
| --- | ---: | ---: |
| Part 1 Common | 39〜55h | 27.5〜74h |
| Part 2 Common | 30〜43h | 20〜57.5h |
| **Part 1 + Part 2 Common** | **69〜98h** | **47.5〜131.5h** |

学習計画では、Common全体を**約80時間前後**で置き、受講者ごとのコード、Git、CIの習熟速度に応じて調整する想定です。
...
CommonとNative specializationをすべて受講する場合、学習工数は標準で**約81〜116.5時間**を想定します。
...
- Common環境準備: 標準 **3.5〜7時間**
- Native環境準備追加: 標準 **5〜7.5時間**
- Common + Native環境準備: 標準 **8.5〜14.5時間**
