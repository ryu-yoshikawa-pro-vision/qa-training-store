...
Androidは標準Native Runtime対象で、Maestroはユーザー操作、Observation、Evidence、Atomic Findingに接続します。iOSは独立BuildとBuild-time guard/artifactを検証し、Simulator Runtime/Maestroは正式Gateにしません。
