...
12. Maestroは`-Action Test`で`maestro/native-test-control.yaml`を1本だけ実行する。単体 Flow が失敗したら後続 Suite を実行せず、Screenshot、Hierarchy、logcat、JUnit、Maestro Outputの最初の異常を確認する。
