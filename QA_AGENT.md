...
- Gray-box: NormalのReadonly Boundaryに加え、許可されたSeed、Test Control、Clock Control、Payment Delay、Deep Link、App Restart、Narrow Console/Log、DOM、Accessibility capabilityを使用できます。Source、Test、Patch、Answer Keyは見ません。
