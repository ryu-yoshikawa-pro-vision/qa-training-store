...
- repository working treeのファイルを変更する実装・変更タスクでは、checkbox完了後に`AGENTS.md`の完了条件へ従ってcommit・push・最新PR headの必須CI確認を行う。ユーザー向けProgressでは、必要な場合にpush後の必須CI確認1件を加算するが、TASKS checkboxには追加しない。
