...
- [x] 1. 必須文書、既存branch safety機構、最近のRunを確認する
- [x] 2. 初期状態、PR head、remote main、5コミットを特定する
...
- D1. current branchのupstreamが `origin/main` だったため、文書化に加えてPR remote branchへのupstream是正を行う。
