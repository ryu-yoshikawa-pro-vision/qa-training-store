...
- [x] 1. PLAN、AGENTS、repair-loop手順、scope、PR #116のbranch / headを確認する
- [x] 2. H98-2、P1-6 Outcome定義、既存checklist構造を確認する
...
- [ ] 5. Run ArtifactをSanitizeし、commit前branch safetyを確認してcommit / pushする
