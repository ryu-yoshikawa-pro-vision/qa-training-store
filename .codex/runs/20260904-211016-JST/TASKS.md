...
- [x] 1. Runを初期化し、branch、必須文書、Issue #96、mainとの差分を確認する。
- [x] 2. Breadcrumb全consumer、共通Component、CSS、component／E2E／a11y testを調査しroot cause仮説を確定する。
- [x] 3. 計画書を `docs/plans/` とRun Artifactへ保存する。
- [x] 4. 手書き4画面を既存 `Breadcrumbs` componentへ置換し、Navigation情報を維持する。
