...
- [x] 1. branch／tree／PR／Issue／#135／CLI version／公式Hooks仕様／既存文書を確認する
- [x] 2. `must_fix`分類、bounded scope、仮説、検証計画をPLANへ確定する
- [x] 3. `codex-safety-harness.md`へHook trust運用の正本を追加する
- [x] 4. `codex-implementation-harness.md`へ正本への最小参照を追加する
- [x] 5. 変更差分、禁止対象非変更、scopeを確認する
- [x] 6. format／Markdown lint／text lint／diff check／verifyと代替工程の結果を確定する
- [x] 7. Run Artifactをfinal commit前状態まで更新・sanitizeし、commit対象を確定する
- [x] 8. Git branch safety preflightとfinal commit対象を確定する
