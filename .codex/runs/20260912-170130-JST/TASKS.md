...
- [x] 1. 開始状態、前回Run、関連export、source差分、Codex versionを確認する。
- [x] 2. strict Runを作成し、PLAN／TASKS／REPORTの目的と停止条件を確定する。
- [x] 3. 新規diagnostic scriptを`async main()`形式へ修正し、dry-runで起動可能性を確認してSHA256を固定する。
